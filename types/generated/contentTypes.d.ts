...
export interface ApiConfiguracaoGeralConfiguracaoGeral
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descricaoSite: Schema.Attribute.Text;
    emailContato: Schema.Attribute.Email;
    ...
    menuPrincipal: Schema.Attribute.Component<'layout.link-menu', true>;
    nomeDoSite: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    redesSociais: Schema.Attribute.Component<'layout.rede-social', true>;
